...
import net.minecraft.world.entity.animal.bee.Bee.BeeLocateHiveGoal;
...
public class MixinLocateHiveGoal {
    ...
    private Stream<BlockPos> onComparingDouble(Stream<BlockPos> instance, Comparator<BlockPos> comparator,
        ...
        return original.call(instance, Comparator.comparingDouble( pos -> BlockPos.containing(VSGameUtilsKt.toWorldCoordinates(this.field_20375.level(), (BlockPos) pos)).distSqr(blockPos)));
    }
}
